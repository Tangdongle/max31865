defmodule Max31865.TestSupport.SimDevice do
  @moduledoc """
  ...
  defimpl SPIDevice do
    alias Max31865.TestSupport.SimDevice, as: Max31865SimDevice
    ...
    @impl SPIDevice
    def render(state) do
      # Return a string summary of your device state
      "Max31865: RTD=#{state.rtd_raw} Ohms"
    end
